...
# Form implementation generated from reading ui file 'login_dialog_sg.ui'
#
...
"}")
        ...
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap(":/tk-framework-login/shotgun_logo_light_medium.png"))
...
"background-color: rgb(35, 165, 225);")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/tk-framework-login/google_authenticator.png"))
        ...
        self.invalid_code.setWordWrap(True)
...
"background-color: rgb(35, 165, 225);")
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/tk-framework-login/backup_codes_light_bg.png"))
        ...
        self.invalid_backup_code.setWordWrap(True)
...
"background-color: rgb(35, 165, 225);")
    ...
    def retranslateUi(self, LoginDialog):
        ...
        self.forgot_password_link.setText(QtGui.QApplication.translate("LoginDialog", "<html><head/><body><p><a href=\"http://6-1-develop.shotgunstudio.com/user/forgot_password\"><span style=\" text-decoration: underline; color:#c0c1c3;\">Forgot your password?</span></a></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
